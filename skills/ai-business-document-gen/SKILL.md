...
| Any deck output (`deck-vc`, `deck-b2b`, `deck-hybrid`) | `references/deck-infographic-system.md` (MANDATORY — visual-first doctrine + component library) + `references/research/executive-deck-craft-2026.md` (decision-first structure, action titles, 5-second rule, credibility killers) + `references/research/nano-banana-pro-prompting-2026.md` (NB2 prompt craft) + `references/image-prompt-templates.md` §4 per-slide formulas |
...
11. **DECK MODES (`deck-vc`, `deck-b2b`, `deck-hybrid`) — visual-first + executive-craft enforcement.** Read `references/deck-infographic-system.md` + `references/research/executive-deck-craft-2026.md` + `references/research/nano-banana-pro-prompting-2026.md` BEFORE authoring any slide. Then enforce, per slide:
    - **Every concept/data slide MUST use a named component from `deck-infographic-system.md §3`** (stat-trio, waterfall, input→AI→output flow, hub-radial, stage timeline, comparison/VS, layered stack, icon-flow grid, photo-hero). **Bullet-card text walls = HARD FAIL** — route back and rebuild as a component.
    - **Action titles**: every slide headline is a complete sentence stating a conclusion, ≤15 words, verb-led, quantified where possible (`executive-deck-craft-2026 §3`). A topic-label title (e.g. "Market Overview") = HARD FAIL. Passes the billboard test.
    - **One idea per slide**; **5-second rule** (a stranger grasps the slide's point in ≤5s); **≤25 words of live text per slide, zero full sentences in the body** (`deck-infographic-system §5` + `executive-deck-craft §4–5`).
    - **Zero hedge words** anywhere ("I think", "maybe", "might", "possibly", "mungkin", "sepertinya").
    - **NB2 prompts authored per `nano-banana-pro-prompting-2026`**: 6-component formula, exact hex (no color names), named layout + named style, negative prompt, ≥2K. In `html-css` mode NB2 backgrounds are **text-free** (live text via CSS overlay); only `full-image` mode bakes in-image text using the two-step + "quotes" + legibility rules.
    - **Run the §6 pre-render visual self-check gate** in `deck-infographic-system.md` for every slide before emit; a slide that fails the gate does not ship.
...
|---|---|---|---|
| `deck-vc` | **+deck-infographic-system.md, +executive-deck-craft-2026.md, +nano-banana-pro-prompting-2026.md**, +image-prompt-templates.md §4, +html-css-print-templates.md §1 (landscape), +safety-filter-playbook.md (cover/CTA), +seedance-templates (motion slides), +remotion-templates (counters/charts) | **+deck-infographic-system.md, +executive-deck-craft-2026.md, +nano-banana-pro-prompting-2026.md**, +image-prompt-templates.md §4 (per-slide), +safety-filter-playbook.md, +pdf-print-production-2026.md §3 (300dpi for print export), +seedance-templates (motion) | +image-prompt-templates.md §4, +safety-filter-playbook.md (cover/CTA prompts only) |
| `deck-b2b` | **+deck-infographic-system.md, +executive-deck-craft-2026.md, +nano-banana-pro-prompting-2026.md**, +image-prompt-templates.md §4, +html-css-print-templates.md §1, +b2b-channel-partner-playbook.md (dual-stakeholder framing), +safety-filter-playbook.md, +seedance-templates | **+deck-infographic-system.md, +executive-deck-craft-2026.md, +nano-banana-pro-prompting-2026.md**, +image-prompt-templates.md §4, +b2b-channel-partner-playbook.md, +safety-filter-playbook.md, +pdf-print-production-2026.md §3 | +image-prompt-templates.md §4, +b2b-channel-partner-playbook.md, +safety-filter-playbook.md |
| `deck-hybrid` | **+deck-infographic-system.md, +executive-deck-craft-2026.md, +nano-banana-pro-prompting-2026.md**, +image-prompt-templates.md §4, +html-css-print-templates.md §1, +b2b-channel-partner-playbook.md, +safety-filter-playbook.md, +seedance-templates, +remotion-templates | **+deck-infographic-system.md, +executive-deck-craft-2026.md, +nano-banana-pro-prompting-2026.md**, +image-prompt-templates.md §4, +b2b-channel-partner-playbook.md, +safety-filter-playbook.md, +pdf-print-production-2026.md §3 | +image-prompt-templates.md §4, +b2b-channel-partner-playbook.md, +safety-filter-playbook.md |
